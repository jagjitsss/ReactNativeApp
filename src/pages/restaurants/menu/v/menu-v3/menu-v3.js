...
import { FlatList, ImageBackground ,  ScrollView, SafeAreaView, Text, View, TouchableOpacity, Image } from 'react-native';
...
export default class RestaurantMenu3 extends React.Component {
  ...
  renderRestaurants = ({ item, index }) => (
    <TouchableOpacity  underlayColor='rgba(73,182,77,0.9)'  >
      ...
      <Image source={{uri:item.photo_url}}  style={{width:100, height:100,borderRadius:10}} />
    </View>
    </TouchableOpacity >
  );
